...
$('#breakdown-articles-block').on('change', 'select[name="main-a-categories"]', function () {
    const categoryId = $(this).val();
...
$('#breakdown-articles-block').on('change', 'select[name="main-a-subcategories"]', function () {
    const subcategoryId = $(this).val();
...
$('#breakdown-articles-block').on('change', 'select[name="main-a-teams"]', function () {
    const teamId = $(this).val();
...
$('#breakdown-articles-block').on('click', '.main-a-articles-selector', function () {
    const outerBox = $(this).parent();;
    const selectorBody = outerBox.find('.custom-selector-body');
    selectorBody.toggle();
});

$('#breakdown-articles-block').on('click', '.custom-selector-body option', function () {
    const selectedOption = $(this);
    const outerBox = $(this).parent().parent();
    const selectorBody = outerBox.find('.custom-selector-body');
    const selector = outerBox.find('.main-a-articles-selector option');
