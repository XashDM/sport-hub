...
namespace SportHub.Pages
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(ILogger<LoginModel> logger, IUserService userService, IJwtSigner jwtSigner, IEmailService emailService, [FromServices] IFluentEmail mailer)
        {
            _logger = logger;
