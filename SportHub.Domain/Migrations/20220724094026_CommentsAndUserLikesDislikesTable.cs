...
{
    public partial class CommentsAndUserLikesDislikesTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentUserLikeDislikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentUserLikeDislikes_MainComments_MainCommentId",
                        column: x => x.MainCommentId,
                        principalTable: "MainComments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentUserLikeDislikes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentUserLikeDislikes_MainCommentId",
                table: "CommentUserLikeDislikes",
                column: "MainCommentId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentUserLikeDislikes_UserId",
                table: "CommentUserLikeDislikes",
                column: "UserId");
